...
def _vaultcreds():
  ...
  try:
    ...
    list_roles_response = client.secrets.aws.list_roles(mount_point='aws')
    ...
    gen_creds_response = client.secrets.aws.generate_credentials(name=role.strip(), mount_point='aws')
